...
flowchart TD
    subgraph Document["Document Layer"]
        ...
        Clip["Clipboard"]
        AppState["AppState"]
        BinFile["BinaryFileData"]
    end

    subgraph Elements["Element Hierarchy"]
        Elem["Element (base)"]
    ...
    subgraph Utilities["JSON Utilities"]
    ...
    Doc -->|"elements: List&lt;Element&gt;"| Elem
    Doc -->|"appState"| AppState
    Doc -->|"files: Dict"| BinFile
    Clip -->|"elements: List&lt;Element&gt;"| Elem
    Clip -->|"files: Dict"| BinFile
    ...
    Elem -->|"extends"| Rect
    Elem -->|"extends"| Ellipse
    Elem -->|"extends"| Diamond
    Elem -->|"extends"| Freedraw
    Elem -->|"extends"| Text
    ...
    Elem -->|"extends"| Image
    Elem -->|"extends"| Frame
    Elem -->|"extends"| MagicFrame
    Elem -->|"extends"| Embeddable
    Elem -->|"extends"| IFrame
    ...
    Elem -->|"extends"| Linear
    Linear -->|"extends"| Line
    Linear -->|"extends"| Arrow
    Linear -->|"startBinding/endBinding"| PointBinding
    Image -->|"crop"| ImageCrop

    linkStyle 15 opacity:1
    linkStyle 16 opacity:1
    linkStyle 17 opacity:1
    linkStyle 18 opacity:1
    linkStyle 19 opacity:1

    Image -->|"fileId →"| BinFile
    Elem -->|"boundElements"| BoundElement
    Elem -->|"roundness"| Roundness
    Roundness -->|"type"| RoundnessType
    Elem -->|"type discriminator"| ElemType

    linkStyle 20 opacity:1
    linkStyle 21 opacity:1
    linkStyle 22 opacity:1
    linkStyle 23 opacity:1
    linkStyle 24 opacity:1

    Elem -->|"constructed via"| ElementBounds
    Parser -->|"uses"| Converter
    Parser -->|"uses"| SnakeConv
    SnakeConv -->|"delegates"| Pascal
    Converter -->|"instantiates"| Elem

    linkStyle 25 opacity:1
    linkStyle 26 opacity:1
    linkStyle 27 opacity:1
    linkStyle 28 opacity:1
    linkStyle 29 opacity:1

    ISeq -->|"used by ctors of"| Elem
```
